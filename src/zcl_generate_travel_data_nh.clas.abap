CLASS zcl_generate_travel_data_nh DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_nh IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_nh.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_nh.

*   insert the new table entries
    INSERT ztravel_nh FROM TABLE @itab.
